                  ...
                  <ul class="nav nav-pills nav-justified">
                   <li>
                            ...
                            if (isset($_SESSION['CUSID'])){  
                              ...
                              echo ' <a href="'.web_root. 'customer/controller.php?action=addwish&proid='.$result->PROID.'" title="Tambah ke Favorit"><i class="fa fa-plus-square"></i></a></a>
                            ';

                             }else{
                               echo   '<a href="#" title="Tambah ke Favorit" class="proid"  data-target="#smyModal" data-toggle="modal" data-id="'.  $result->PROID.'"><i class="fa fa-plus-square"></i></a></a>
                            ';
                            }  
                            ?>

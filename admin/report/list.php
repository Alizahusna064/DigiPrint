 	    ...
 	    <div class="row">
		  <div class="col-md-12">
			 <div class="form-group input-group" style="margin-top:25px;">  
                <button class="btn btn-primary btn-sm" name="submit" type="submit" >Cari <i class="fa fa-search"></i>
                </button> 
            </div>
		   </div>  
	    </div> 
...
<span id="printout">
	<div class="col-md-12" >
	<div class="page-header" style="text-align:center;" ><h1>Daftar Produk</h1>
		<div>Tanggal: Dari : <?php echo isset($_POST['date_pickerfrom']) ? $_POST['date_pickerfrom'] :'';?> - Ke : <?php echo isset($_POST['date_pickerto']) ? $_POST['date_pickerto'] : '';?> </div>
	</div>
...
//            date(ORDEREDDATE) <= '". date_format(date_create($_POST['date_pickerto']), "Y-m-d")."'";
			...
			echo '<tr><td colspan="7" align="center"><h2>Masukkan Tanggal Terlebih Dahulu</h2></td></tr>';
...
<tfoot>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="col-md-2"> 	
			<button onclick="tablePrint();" class="btn btn-primary"><i class="fa fa-print"></i> Cetak Laporan</button>
 		</div>
	  </div>
	</div>
</div>

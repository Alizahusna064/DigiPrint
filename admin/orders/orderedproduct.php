...
<div class="modal-content">
	<div class="modal-header">
		...
		"button">×</button>
		<h2>Nomor Pemesanan : <?php echo $_SESSION['ordernumber']; ?></h2>
	...
	<div class="row" style="margin:2%">
		<div class="col-md-6">Nama : <?php echo $cur->FNAME . ' '.  $cur->LNAME ;?></div>
		<div class="col-md-6">Alamat :  <?php echo $cur->CUSHOMENUM . ' ' . $cur->STREETADD . ' ' .$cur->BRGYADD . ' ' . $cur->CITYADD . ' ' .$cur->PROVINCE . ' ' .$cur->COUNTRY; ?>
     </div>
	</div>
	...
	"post">
       ...
       <div class="row">
		  	<div class="col-md-6 pull-left">
		  	 <div>Tanggal Pemesanan : <?php echo date_format(date_create($cur->ORDEREDDATE),"M/d/Y h:i:s"); ?></div> 
		  		<div>Metode Pembayaran : <?php echo $cur->PAYMENTMETHOD; ?></div>

		  	</div>
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Harga Total : Rp. <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Biaya Pengiriman : Rp. <?php echo number_format($cur->DELFEE,2); ?></p>
		  		<p align="right">Jumlah Yang Harus Dibayar : Rp. <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div> 
		</div>   

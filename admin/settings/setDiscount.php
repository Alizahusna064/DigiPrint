            ...
            <div class="col-md-6">
              ...
              <input type="hidden" name="PROID" value="<?php  echo $result->PROID; ?>">
                ...
                <ul>
                    ...
                    <li>Tipe - <?php echo $result->PRODESC; ?></li>
                    <li>Harga - Rp. <?php echo $result->PROPRICE; ?></li>
                    <li>Diskon - <?php echo $result->PRODISCOUNT; ?> % </li> 
                    <li>Harga Diskon - Rp. <?php echo $result->PRODISPRICE; ?> </li> 
                </ul>
...
<div class="row">
        <div class="col-md-12">
        <h3 class="page-header">Terapkan Diskonnya</h3>
        <div class="col-md-6">

              ...
              <div class="form-group">
                 ...
                 <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8"> 
                      <textarea class="form-control input-sm" id="PRODESC" name="PRODESC" placeholder="Masukkan Deskripsinya" cols="1" rows="3" ></textarea>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-3">
                         <input class="form-control input-sm" id="ORIGINALPRICE" name="ORIGINALPRICE" placeholder=
                            "Harga Aslinya" type="number" value=""  step="any">
                      </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="PROQTY" name="PROQTY" placeholder=
                            "Masukkan Jumlahnya" type="number" value="">
                      </div>

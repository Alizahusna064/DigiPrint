<?php
		...
		<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Daftar Produk  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Baru</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				...
				<table id="dash-table"  class="table table-striped table-bordered table-hover "  style="font-size:12px" cellspacing="0" >
				  ...
				  <thead>
				  	<tr> 
				  		...
				  		<!-- <th>Model</th>  -->
				  		<!-- <th align="left"><input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');"> Produk</th>  -->
				  		<th>Produk</th> 
			  ...
			  <tbody>
				...
				<div class="btn-group">
				  <!-- <a href="index.php?view=add" class="btn btn-default">Tambah</a> -->
				  <button type="submit" class="btn btn-default" name="delete"><i class="fa fa-trash fw-fa"></i> Hapus Yang Ditandai</button>
				</div>
				</div>
				</form>

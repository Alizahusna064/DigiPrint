...
function doInsert(){
	if(isset($_POST['save'])){
		...
		if ( $errofile > 0) {
				message("Silahkan Pilih Gambar", "error");
	...
	function doEdit(){
		...
		if(isset($_POST['save'])){
			...
			message("Product telah diperbarui!", "success");
			redirect("index.php");
	  }
	redirect("index.php"); 
}
	...
	function doDelete(){
		...
		if (isset($_POST['selector'])==''){
			message("Silahkan Pilih Item Yang Ingin Dihapus","error");
			redirect('index.php');
			}else{

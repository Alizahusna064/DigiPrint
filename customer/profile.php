    ...
    <div class="col-sm-3">
        <div class="panel">
            ...
            <!-- <li class="list-group-item text-muted">Profile</li> -->
                ...
                "pull-left"><strong>Nama</strong></span>
                <?php echo $res->FNAME .' '.$res->LNAME; ?></li>
                <li class="list-group-item text-right"> 
                <div class="panel-group" id="accordion">   
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"  >Ganti Password</a>
                  <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="panel-body">
                        <form action="<?php echo web_root; ?>customer/controller.php?action=changepassword" method="POST"> 
                          <input type="password" class="form-control" name="CUSPASS" required placeholder="Masukkan Password Baru"><br/>
                          <input class="btn btn-sm btn-primary" type="submit" name="save"  value="Ganti">
                        </form>
                      </div>
                  </div>
                </div> 
        ...
        <div class="panel">
            <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active">
                        <a data-toggle="tab" href="#home">Daftar Pesanan</a>
                    </li> 
                    <li>
                    ...
                    <li>
                        <a data-toggle="tab" href="#wishlist">Favorit</a>
                    </li>
                </ul>
                                ...
                                id="example" style="font-size:12px">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Status</th>
                                            <th width="150px">Catatan (Opsional)</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
            ...
            <div class="modal-content">
                ...
                "multipart/form-data" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        type="button">Tutup</button> <button class=
                        "btn btn-pup" name="savephoto" type="submit">Unggah Foto</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->

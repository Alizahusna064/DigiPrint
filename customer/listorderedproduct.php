...
<?php 
	...
	echo "<h5>Pesananmu Sedang Dalam Proses. Silahkan Cek Profil Kamu Untuk Notifikasi Selanjutnya...</h5>";
} 
?>
<hr/>
		...
		?>
 		...
 		<div class="row">
		  	<div class="col-md-6 pull-left">
		  	 <div>Tanggal Dipesan : <?php echo date_format(date_create($cur->ORDEREDDATE),"M/d/Y h:i:s"); ?></div> 
		  		<div>Metode Pembayaran : <?php echo $cur->PAYMENTMETHOD; ?></div>

		  	</div>
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Harga : Rp. <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Biaya Pengiriman : Rp. <?php echo number_format($price,2); ?></p>
		  		<p align="right">Harga Yang Harus Dibayar : Rp. <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>

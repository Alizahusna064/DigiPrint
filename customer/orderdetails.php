...
<section id="cart_items">
    ...
    <input type="hidden" value="<?php echo $res->AUTO; ?>" id="ORDEREDNUM" name="ORDEREDNUM">
      Pesanan Nomor : <?php echo $res->AUTO; ?>
    </div>
    </div>
 </div>
      <div class="table-responsive cart_info"> 
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Harga Total : Rp. <span id="sum">0.00</span></div>
                   <div > Biaya Pengiriman : Rp. <span id="fee">0.00</span></div>
                   <div> Harga Yang Harus Dibayar : Rp. <span id="overall"><?php echo $tot ;?></span></div>
 ...
 <section id="do_action">
    <div class="container">
      <div class="heading">
        <h3>Apa Yang Selanjutnya Kamu Lakukan Disini?</h3>
      ...
      <div class="row">
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                      <label >
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfee" value="COD" checked="true" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >Cash on Delivery 
                        ...
                        <div class="panel"> 
                                <div class="panel-body">
                                    <div class="form-group ">
                                      <label>Alamat Untuk Dikirimkan</label>

                                    
                                        <div class="col-md-12">
                                          <label class="col-md-4 control-label" for=
                                          "PLACE">Tempat (Kecamatan/Kota):</label>
...
<br/>
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                      <button type="submit" class="btn btn-pup  pull-right " name="btn" id="btn" onclick="return validatedate();"   /> Pesan Sekarang <span class="glyphicon glyphicon-chevron-right"></span></button> 
                </div>  
              </div>

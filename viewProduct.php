              ...
              <div class="row">  
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                      ...
                      <li>Tipe - <?php echo $cur->PRODESC; ?></li>
                      <li>Harga - Rp. <?php echo $cur->PROPRICE; ?></li>
                       <?php if($cur->PRODISCOUNT>0){ ?>
                        <li>Diskon - <?php echo $cur->PRODISCOUNT; ?> % </li> 

                        <li>Harga Diskon - Rp. <?php echo $cur->PRODISPRICE; ?> </li> 
                        <?php } ?>
                      <li>Stok - <?php echo $cur->PROQTY; ?></li>
                    </ul> 

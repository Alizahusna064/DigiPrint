                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                              ...
                              <input class="proid" type="hidden" name="proid" id="proid" value="">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-10">
                                    ...
                                    <div class="col-md-8">
                                    <button type="submit" id="modalLogin" name="modalLogin" class="btn btn-pup"><span class="glyphicon glyphicon-log-in "></span>   Masuk</button> 
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="https://bit.ly/2LPn9Wu">Digi Print</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                                     ...
                                     <div class="panel-body">
                                        ...
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                            <input  id="GENDER" name="GENDER" placeholder=
                                                "Gender" type="radio" checked="true" value="Laki-laki"><b> Laki-laki </b>
                                                <input   id="GENDER" name="GENDER" placeholder=
                                                "Gender" type="radio" value="Perempuan"> <b> Perempuan </b>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                          <p>Catatan :</p>
                                            Password Harus Mencakup 8 Sampai 15 Karakter. Hanya Huruf, Nomor, Simbol dan Huruf Pertama Harus Besar.
                                         </div> 
                                        </div>
                                      </div> 
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                                                "+62 8123456789" type="number" value="">
                                          </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Saya Setuju Dengan <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Syarat dan Ketentuan','600','600')"  ><b>Syarat dan Ketentuan</b></a> dari Digi Print.</small>

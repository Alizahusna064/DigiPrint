                                  ...
                                  <br/> 
                                        <?php    
                                            ...
                                            if (isset($_SESSION['CUSID'])){  
                                              ...
                                              echo ' <a href="'.web_root. 'customer/controller.php?action=addwish&proid='.$result->PROID.'" title="Tambah ke Favorit">Tambah ke Favorit</a>
             ';
                                           
                                             }else{
                                               echo   '<a href="#" title="Tambah ke Favorit" class="proid"  data-target="#smyModal" data-toggle="modal" data-id="'.  $result->PROID.'">Tambah ke Favorit</a>
             ';
                                            } 
                            ...
                            <?php  
                                  ...
                                  echo "<h1>Disini Tidak Ada Item Untuk Ditampilkan ...</h1>";
                               } 
                            ?>  
